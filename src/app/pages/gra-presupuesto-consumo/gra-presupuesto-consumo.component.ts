...
@Component({
  selector: 'app-gra-presupuesto-consumo',
  templateUrl: './gra-presupuesto-consumo.component.html',
  styleUrls: ['./gra-presupuesto-consumo.component.css']
})
export class GraPresupuestoConsumoComponent implements OnInit {
...
public barChartData: ChartDataSets[] = [
  ...
  { data: [34, 12, 70, 50, 58, 37, 80], label: 'Cerrados de Mayo' },
  { data: [58, 22, 34, 11, 7, 83, 37], label: 'Ingresos en Mayo'}
];
